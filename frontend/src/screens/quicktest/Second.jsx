...
import das from "@/components/assests/dassault.png";
...
import { API } from '@/components/utils/constant';
 ...
 const Second = () => {
  ...
  return (
    <>
       {!mcq ? (
    <div className="bg-[#D0D2E3] min-h-screen  flex items-center justify-center font-dm-sans">
          <div className="bg-white shadow-lg rounded-2xl flex flex-col justify-center items-center w-11/12 md:w-3/4 lg:w-2/4 py-6 mt-24 lg:mt-12">
            ...
            <div className="bg-[#E7E8F1] flex-col w-full text-center p-6 space-y-2 flex justify-center items-center">
               <Image src={das} className="w-40 h-20 " alt='product'/>
