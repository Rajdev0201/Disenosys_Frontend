...
const ProductQuizScreen = ({ questions }) => {
  ...
  return (
    <>
      <div className="mt-20 flex flex-row justify-center gap-2 items-center mb-4 space-y-2 font-dm-sans">
      ...
      <div className="bg-blue-100 h-screen flex flex-col items-center pt-20 ">
