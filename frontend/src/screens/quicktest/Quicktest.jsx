...
const Quicktest = () => {
  ...
  return (
    <section>
    <div className="bg-[#D0D2E3] min-h-screen flex flex-col items-center justify-center mt-20 lg:mt-12 font-dm-sans">
      <h1 className="text-2xl md:text-5xl font-bold mb-4 mt-10 text-center text-[#101359]">
         Automotive Product Design quiz
      </h1>
      <div className="bg-white shadow-md rounded-md mt-4 flex flex-col md:flex-row items-center w-full sm:w-11/12 md:w-3/4 lg:w-2/3 px-6 sm:px-10 lg:px-20 py-6 sm:py-10 lg:py-16 space-y-6 md:space-y-0">
        <div className="flex items-start lg:items-center justify-start lg:justify-center text-green-500 font-bold text-6xl md:text-7xl mr-4">
          <div className="flex justify-center items-center mt-3 lg:mt-1 gap-2">
            <span className='text-[#101359]'>15</span>
            <div className="text-sm md:text-base font-medium text-[#8C8C8C]">
  ...
  <div className='border-2 lg:border-b-gray-200 lg:border-2 lg:border-r-gray-200 w-full lg:w-0 lg:h-48'></div>
        ...
        <div className="flex flex-col text-[#8C8C8C] text-md space-y-6 mt-2 lg:mt-0 font-medium md:ml-6">
          <p>
          ...
          <Button 
          onClick={onClick} 
          text="Start 15 min test"
          className="bg-gradient-to-r from-[#0BA6DC] to-[#45D2FF] text-white font-medium py-2 px-4 rounded-md mt-4 self-start hover:cursor-pointer hover:bg-blue-300 transition duration-300"
           />
