  ...
  return (
    <div className="space-y-4 font-dm-sans">
      ...
      <p className="text-[#8C8C8C] leading-relaxed text-sm lg:text-md font-medium">
       The <span className="font-semibold text-[#030304]">{slug}</span> is a specialized program designed to provide students with the technical knowledge and industry-relevant skills needed to design high-quality plastic components for 
