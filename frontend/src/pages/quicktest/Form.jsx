...
const Form = () => {
  ...
  return (
    <div className="bg-blue-100 min-h-screen flex items-center justify-center px-4 font-dm-sans">
      <div className="bg-white shadow-md rounded-lg w-full max-w-md p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className={`w-full py-3 rounded-lg font-bold text-md ${
              !load
                ? "bg-gradient-to-r from-[#0BA6DC] to-[#45D2FF] text-white "
