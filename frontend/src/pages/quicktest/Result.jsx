...
#GPDX #automotive #design #exam #CATIA`,
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-blue-100 flex justify-center items-center font-dm-sans lg:p-4">
          ...
          <div className="flex flex-col items-center bg-white rounded-md shadow-md lg:ml-24  lg:w-80 lg:h-96">
            ...
            <div className="mt-8 text-center">
              ...
              <div className="flex space-x-2 justify-center mb-4 lg:mb-0">
                <button className="bg-gray-100 hover:bg-gray-200 rounded-full hover:cursor-pointer  p-2 transition-transform transform hover:scale-110">
                  <Facebook className="w-6 h-6" />
                </button>
                {!accessToken ? (
                  <button
                    className="bg-gray-100 hover:bg-gray-200 rounded-full hover:cursor-pointer p-2 transition-transform transform hover:scale-110"
                      ...
                      <div className="fixed top-0 left-0 right-0 font-poppins bottom-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
                        <div className="bg-white p-5 rounded-md text-gray-800 shadow-md max-w-sm w-full">
                          <h2 className="text-lg font-bold text-gray-600 mb-4">
                            Just One More Step Ahead to Show the World You Are
                            an Improved Design Engineer!
                          </h2>
                          <button
                            onClick={getProfile}
                            className="bg-[#182073] hover:bg-blue-700 hover:cursor-pointer text-white font-medium py-2 px-4 mt-4 rounded-md"
                          >
                            Continue
                          </button>
                        </div>
                      ...
                      <div className="fixed top-0 left-0 right-0 font-poppins bottom-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
                        <div className="bg-white p-5 rounded-md shadow-md max-w-sm w-full">
                          ...
                          <h2 className="text-lg text-gray-600 font-bold mb-4">
                            Nicely done! The post is ready to reach your
                            network.
                          </h2>
                          <div className="flex justify-center">
                            <button
                              onClick={sharePost}
                              className="bg-[#182073] gap-2 flex items-center hover:cursor-pointer hover:bg-blue-700 text-white font-medium py-2 mt-4 px-4 rounded-md"
                            >
                              Share Post
            ...
            {accessToken ? (
              <button
                className="bg-[#182073] rounded text-white text-lg font-semibold ring-2 ring-white px-4 py-1 mt-12"
                onClick={handleBack}
              >
                Back Home
              </button>
