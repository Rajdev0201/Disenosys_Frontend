  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 px-4 font-dm-sans">
      <div className="bg-white w-full sm:w-[90%] md:w-[70%] lg:w-[60%] xl:w-[40%] rounded-2xl shadow-lg overflow-y-auto max-h-[95vh] p-6 relative">
        ...
        {/* Tab Content for Online programs*/}
        {activeTab === "live" ? (
          // Live Program Form
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              This course is available through online classes only. Instructor
              will contact you via WhatsApp for scheduling.
            </p>
            <p className="text-sm text-gray-500 mt-1">
              Fill in your details so the instructor can reach you.
            </p>
            <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="cursor-not-allowed mt-1 w-full rounded-xl border shadow border-gray-300 px-3 py-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400"
                />
              </div>
              ...
              <div className="flex w-full gap-3 pt-4">
                <Button
                  text="Cancel"
                  onClick={onClose}
                  className="px-5 py-2 border rounded-2xl w-full hover:cursor-pointer border-gray-300 text-gray-600 hover:bg-gray-100 font-[300] text-lg"
                />
                <Button
                  type="submit"
                  text="Submit"
                  className="px-6 py-2 rounded-2xl bg-gradient-to-r w-full hover:cursor-pointer from-[#009EE0] to-[#45D2FF] text-white  font-[300] text-lg hover:opacity-90"
                />
              </div>
            </form>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-[#8C8C8C]">
              Unlock full access to all modules, hands-on projects, and industry
              insights.
            </p>
              ...
              <div className="md:col-span-7">
                ...
                <ul className="mt-2 space-y-2 text-sm text-[#8C8C8C]">
                  <li className="flex items-center gap-2">
                    <CheckLine
                      className="text-white p-1 rounded-full bg-green-500"
                      size={18}
                    />
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mt-6">
              ...
              <ul className="space-y-3 text-sm text-[#8C8C8C] flex-1">
                <li className="flex items-center gap-2">
                  <LibraryBig
                    size={18}
                    className="text-white p-1 rounded-full bg-[#101359]"
                  />
        ...
        {/* Tab Content for Placement Programs */}
      </div>
    </div>
  );
};
